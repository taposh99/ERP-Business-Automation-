@extends('layouts.app')
@section('content')
<h2 class="mt-4 mb-4">Edit Manufacturer</h2>
...
<!-- add form -->
<form action="{{ route('admin.update.manufacturer',$manufacturer->id) }}" method="POST">
    @csrf
    <div class="modal-body">
        ...
        <div class="border p-3 rounded">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" name="contact" value="{{ $manufacturer->contact }}" required>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" name="m_product" cols="30" rows="4" required>{{ $manufacturer->m_product }}</textarea>
            </div>
